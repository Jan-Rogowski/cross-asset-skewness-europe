...
PF_PATH = DATA_DIR / "portfolio_bonds_skewness_ls.csv"
OUT_PATH = DATA_DIR / "analysis_bonds_summary.csv"


def max_dd(series: pd.Series) -> float:
    """
    Maksymalne obsunięcie kapitału dla skumulowanych zwrotów.
    """
...
def main():
    ...
    print("Bond summary saved to:", OUT_PATH)
    print(summary)
